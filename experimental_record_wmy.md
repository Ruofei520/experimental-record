...
|10|yolov5|/15|||train_without_2k_num5428|val_num1200(与测试集同分布)|与实验1对比 验证epochs数目对结果的影响并保存每个epoch的结果|img_size train 640 val 640 test 896  batch_size 8|
|11|yolov5|/20|||train_without_2k_num5428|val_num1200(与测试集同分布)|与实验1对比 验证epochs数目对结果的影响并保存每个epoch的结果|img_size train 640 val 640 test 896  batch_size 8|
