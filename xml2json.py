...
data_dir = "/root/python_project/underwater_detection/mmdetection/data/underwater_v2/UnderwaterDetection_roundA/train" #根目录文件，其中包含image文件夹和box文件夹（根据自己的情况修改这个路径）
json_path='/root/python_project/underwater_detection/mmdetection/data/underwater_v2/UnderwaterDetection_roundA/annotations/annotations_train.json' #生成的json存放路径
...
categories_map = {'holothurian': 0, 'echinus': 1, 'scallop': 2, 'starfish': 3} #根据情况修改
